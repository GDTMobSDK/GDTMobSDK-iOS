//
//  ExpressInterstitialFullScreenVideoViewController.m
//  GDTMobApp
//
...
#import "ExpressInterstitialFullScreenVideoViewController.h"
#import "GDTExpressInterstitialAd.h"
#import "GDTAppDelegate.h"

@interface ExpressInterstitialFullScreenVideoViewController ()<GDTExpressInterstitialAdDelegate>
...
@implementation ExpressInterstitialFullScreenVideoViewController
...
- (IBAction)selectADVStyle:(id)sender {
    ...
    NSArray *advTypeTextArray = @[@[@"竖模板", @"2061773850557355"],
                                  @[@"横模板", @"5051374830157407"]];
