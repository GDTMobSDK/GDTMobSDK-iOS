...
- (GDTMediaPlayerStatus)gdtPlayerStatus:(BUPlayerPlayState)buState {
    return (GDTMediaPlayerStatus)self.playerStatusMap[@(buState).stringValue];
}
...
- (void)nativeExpressAdViewRenderSuccess:(BUNativeExpressAdView *)nativeExpressAdView {
    if ([self.connector respondsToSelector:@selector(adapter_nativeExpressAdViewAdapterRenderSuccess:)]) {
        [self.connector adapter_nativeExpressAdViewAdapterRenderSuccess:[self viewAdapter:nativeExpressAdView]];
    }
}
